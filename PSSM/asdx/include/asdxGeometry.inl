...
///------------------------------------------------------------------------------------
///<summary>引数付きコンストラクタです.</summary>
///<param name="value">ビュー射影行列</param>
///------------------------------------------------------------------------------------
ASDX_INLINE
...
{
    // 参照 : http://www.chadvernon.com/blog/resources/directx9/frustum-culling/
...
#else
    Vector3 result = 
        -a.d * Vector3::Cross( b.normal, c.normal ) / Vector3::Dot( a.normal, Vector3::Cross( b.normal, c.normal ) )
        -b.d * Vector3::Cross( c.normal, a.normal ) / Vector3::Dot( b.normal, Vector3::Cross( c.normal, a.normal ) )
        -c.d * Vector3::Cross( a.normal, b.normal ) / Vector3::Dot( c.normal, Vector3::Cross( a.normal, b.normal ) );
    return result;
#endif
}
